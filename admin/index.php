...
<div class="container">
  <div class="page-header">
    <h1 class="h2">Mostrar todos. / <a class="btn btn-default" href="AgreagarNuevo.php"> <span class="glyphicon glyphicon-plus"></span> &nbsp; Agregar nuevo</a></h1>
  </div>
  <br />
  <div class="row">
	...
	$stmt = $pdo->prepare('SELECT Imagen_ID, Imagen_Marca, Imagen_Tipo, 
													 Imagen_Img FROM tbl_imagenes ORDER BY Imagen_ID DESC');
	$stmt->execute();
